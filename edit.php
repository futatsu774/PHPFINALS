...
$sql = "SELECT * FROM `testdummy` WHERE 1";
...
$result = mysqli_query($conn, "UPDATE `testdummy` SET `firstName`='$firstname',`lastName`='$lastname',`email`='$email',`birthday`='$birthday',`gender`='$gender',`contact`='$contact',`nid`='$nid',`address`='$address',`dept`='$dept',`degree`='$degree' WHERE id=$id");
...
<?php
	...
	$sql = "SELECT * from `testdummy` WHERE id=$id";
	$result = mysqli_query($conn, $sql);
	if($result){
            ...
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form id = "registration" action="edit.php" method="POST">
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="number"  placeholder="Contact"name="contact" value="<?php echo $contact;?>">
                        </div>

                        <div class="input-group">
                            <input class="input--style-1" type="number"  placeholder="NID"name="nid" value="<?php echo $nid;?>">
                        </div>
